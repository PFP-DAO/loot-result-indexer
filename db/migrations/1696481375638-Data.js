module.exports = class Data1696481375638 {
    name = 'Data1696481375638'

    async up(db) {
        await db.query(`CREATE TABLE "loot_info" ("id" character varying NOT NULL, "tx_hash" text NOT NULL, "timestamp" numeric NOT NULL, "user" text NOT NULL, "captain_id" integer NOT NULL, "guar_result" jsonb NOT NULL, "loot_results" jsonb NOT NULL, "level_result" jsonb, "pay_loot" jsonb, "claim" jsonb, CONSTRAINT "PK_643df6f39f821326c11c918e7fd" PRIMARY KEY ("id"))`)
